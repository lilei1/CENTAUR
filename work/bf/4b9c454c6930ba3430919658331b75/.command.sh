#!/bin/bash -ue
echo "Processing methylation data for TEST_003" > TEST_003_methylation_test.txt
echo "Sample type: Cancer" >> TEST_003_methylation_test.txt
echo "Cancer type: Lung" >> TEST_003_methylation_test.txt
echo "Stage: Late" >> TEST_003_methylation_test.txt
echo "Input file: TEST_003_R1.fastq.gz" >> TEST_003_methylation_test.txt
echo "Processing completed at: $(date)" >> TEST_003_methylation_test.txt
...
df.to_csv('TEST_003_fragmentomics_test.tsv', sep='	', index=False)
print(f'Generated fragmentomics features for TEST_003')
"
