#!/bin/bash -ue
echo "Processing multi-omics integration for INTEGRATION_TEST_002" > INTEGRATION_TEST_002_integration_test.txt
    echo "Sample type: Control" >> INTEGRATION_TEST_002_integration_test.txt
    echo "Cancer type: CRC" >> INTEGRATION_TEST_002_integration_test.txt
    echo "Stage: Early" >> INTEGRATION_TEST_002_integration_test.txt
    echo "Processing completed at: $(date)" >> INTEGRATION_TEST_002_integration_test.txt
...
print(f'Processing INTEGRATION_TEST_002 - Control')
...
all_features = {
    'sample_id': 'INTEGRATION_TEST_002',
    'cancer_type': 'CRC',
    'stage': 'Early',
    'sample_type': 'Control',
    **methylation_features,
...
harmonized_df.to_csv('INTEGRATION_TEST_002_harmonized_features.tsv', sep='	', index=False)
...
biomarker_df.to_csv('INTEGRATION_TEST_002_biomarker_features.tsv', sep='	', index=False)
...
ml_df.to_csv('INTEGRATION_TEST_002_ml_features.tsv', sep='	', index=False)

print(f'Generated multi-omics integration for INTEGRATION_TEST_002')
